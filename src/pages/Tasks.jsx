    ...
    <div className="w-full min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="py-4 px-6 md:px-12 shadow-sm border-b border-gray-200 bg-white sticky top-0 z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="flex items-center space-x-4">
            <Link to="/tasks" className="text-purple-600 font-semibold">My Tasks</Link>
            {user && (
              <button 
                onClick={signOut} 
      ...
      <main className="flex-grow container mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Your Tasks</h1>
          <Link
            to="/tasks/new"
        ...
        {tasks.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-xl text-gray-500">You have no tasks yet. Create one to get started!</p>
          </div>
        )}
      </main>
